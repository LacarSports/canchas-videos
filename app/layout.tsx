    ...
    <html lang="es" className={`${geist.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-lake-950">
        ...
        <a
          ...
          className="group fixed bottom-6 right-6 z-40 flex items-center gap-2.5 bg-lake-900/85 backdrop-blur-xl border border-mist-500/12 hover:border-crystal-400/35 rounded-full pl-3.5 pr-4 py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.45)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.45),0_0_20px_rgba(41,196,173,0.15)] transition-all duration-300 active:scale-[0.97]"
        >
          {/* WhatsApp icon */}
          <svg
            className="w-5 h-5 text-crystal-400 shrink-0"
            viewBox="0 0 24 24"
            fill="currentColor"
          >
